...
export function Vision() {
  return (
    <section id="vision" className="bg-blue-50 dark:bg-blue-900 py-16 sm:py-24">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <Card className="w-full overflow-hidden shadow-lg bg-white dark:bg-gray-800">
          <CardContent className="p-8 sm:p-12">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-8 text-center sm:text-5xl">
              Our Vision
            </h2>
            <p className="text-gray-700 dark:text-gray-300 text-lg sm:text-xl leading-relaxed text-center max-w-4xl mx-auto">
